 ...
 */
package cmg.collections {

	import cmg.collections.framework.IComparator;
	import cmg.collections.framework.IIterator;
	import cmg.collections.framework.ISortedMap;
	import cmg.collections.framework.core.AbstractSortedDuplicatesCollection;
	import cmg.collections.framework.core.SortedMapIterator;
	import cmg.collections.framework.core.SortedMapNode;
	import cmg.collections.framework.core.SortedNode;
	import cmg.collections.framework.core.as3commons_collections;
	 ...
	 * @see cmg.collections.framework.ISortedMap ISortedMap interface - Detailed description of the sorted map features.
	 * @see cmg.collections.framework.IMapIterator IMapIterator interface - Detailed description of the map iterator features.
	 * @see cmg.collections.framework.IMap IMap interface - Detailed description of the base map features.
	 */
...
import cmg.collections.SortedMap;
import cmg.collections.framework.IIterator;
import cmg.collections.framework.core.SortedMapNode;
import cmg.collections.framework.core.SortedNode;
import cmg.collections.framework.core.as3commons_collections;
