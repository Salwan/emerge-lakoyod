...
package cmg.collections.fx {
	import cmg.collections.ArrayList;
	...
	import cmg.collections.fx.events.ListEvent;
	...
	/**
	 * @eventType cmg.collections.fx.events.CollectionEvent.COLLECTION_CHANGED
	 */
	[Event(name="collectionChanged", type="cmg.collections.fx.events.ListEvent")]
	 ...
	 * @see cmg.collections.fx.events.ListEvent ListEvent - Description of the list event properties.
	 * @see cmg.collections.ArrayList ArrayList - ArrayList description and usage examples.
	 */
