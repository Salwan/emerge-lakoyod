...
package cmg.collections {
	...
	import cmg.collections.framework.IOrderedList;
	import cmg.collections.framework.core.AbstractList;
	import cmg.collections.framework.core.ArrayListIterator;
	import cmg.collections.utils.ArrayUtils;
	 ...
	 * @see cmg.collections.framework.IOrderedList IOrderedList interface - Detailed description of the ordered list features.
	 * @see cmg.collections.framework.IOrderedListIterator IOrderedListIterator interface - Detailed description of the ordered list iterator features.
	 * @see cmg.collections.framework.IList IList interface - Detailed description of the base list features.
	 */
