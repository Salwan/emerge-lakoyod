...
package cmg.collections {
	...
	import cmg.collections.framework.ISortedSet;
	import cmg.collections.framework.core.AbstractSortedCollection;
	import cmg.collections.framework.core.SortedNode;
	import cmg.collections.framework.core.SortedSetIterator;
	 ...
	 * @see cmg.collections.framework.ISortedSet ISortedSet interface - Detailed description of the sorted set features.
	 * @see cmg.collections.framework.ISetIterator ISetIterator interface - Detailed description of the set iterator features.
	 * @see cmg.collections.framework.ISet ISet interface - Detailed description of the base set features.
	 */
