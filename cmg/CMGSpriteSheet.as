package cmg 
{
	...
	/**
	 * Defines a sprite sheet from a bitmap source, it supports both whole sheet definition and invidual definitions
	 * Sprites are retrieved by name or number: sprite_prefix + number
	 * @author ZenithSal
	 */
	public class CMGSpriteSheet
	{
		...
		public function CMGSpriteSheet(bitmap:BitmapData) 
		{
			mBitmap = bitmap;
			mSprites = new Map();
			mBitmapMap = new Map();
