package cmg
{
	...
	/**
	 * Shows messages on screen in stylish box.
	 * @author ZenithSal
	 */
	public class DebugBar extends MovieClip
	{
		...
		public function unlock():void
		{
			...
			{
				Tweener.removeTweens(this);
				Tweener.addTween(this, { time:1, alpha:0, transition:"linear" } );
				isLocked = false;
			}
		}
		...
		public function tracePerma(text:String):void
		{
			Tweener.removeTweens(this);
			mText.textColor = 0x3E94D2;
			mText.text = text;
			alpha = 1;
			isLocked = true;
		}
